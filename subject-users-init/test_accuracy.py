...
user_assignments = {u_id: groups_train[category_users_train == u_id][0]
                    for u_id in np.unique(category_users_train)}
groups_test = np.array([user_assignments.get(u_id, 0) for u_id in category_users_test])
